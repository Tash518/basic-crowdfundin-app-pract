    ...
    return (
        <div className='text-white py-14 container mx-auto'>
            ...
            <div className="social-login-buttons ">
                <div className="flex flex-col gap-2 min-h-screen justify-center items-center p-10">


                    <button
                        className="flex items-center text-black bg-slate-50 border w-64 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
